  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="relative flex h-full flex-col items-start justify-end p-10 text-white">
          ...
          <p className="mt-2 max-w-sm text-sm text-white/80">
            Tạo tài khoản miễn phí và khám phá hàng trăm AI API mạnh mẽ cho dự
            án của bạn.
          </p>
        </div>
      </div>
      ...
      <div className="relative flex flex-1 flex-col justify-center overflow-hidden px-6 py-10 sm:px-12 lg:px-20">
        ...
        <div className="pointer-events-none absolute -bottom-24 -left-24 size-[300px] rounded-full bg-emerald-400/5 blur-3xl dark:bg-emerald-500/8" />
        ...
        <div className="relative mx-auto w-full max-w-md">
          ...
          <Link
            href="/"
            className="mb-8 block text-2xl font-[800] text-foreground"
          >
            Operis
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Đăng ký để bắt đầu sử dụng các API mạnh mẽ.
          </p>
            ...
            {register.isError && (
              <p className="text-center text-sm text-red-500">
                {register.error instanceof AxiosError
                  ? register.error.response?.data?.message || "Đăng ký thất bại"
                  : "Đăng ký thất bại"}
              </p>
            )}
            <button
              ...
              className="w-full cursor-pointer rounded-lg bg-primary py-3 text-base font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {register.isPending ? (
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-lg border border-border py-3 text-sm font-semibold text-foreground transition-colors hover:bg-accent"
            >
            ...
            {/* <button type="button" onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/github`; }} className="flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-lg border border-border py-3 text-sm font-semibold text-foreground transition-colors hover:bg-accent">
