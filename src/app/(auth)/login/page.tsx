  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative flex flex-1 flex-col justify-center overflow-hidden px-6 py-10 sm:px-12 lg:px-20">
        {/* Decorative elements */}
        <div className="pointer-events-none absolute -left-32 -top-32 size-[400px] rounded-full bg-emerald-400/5 blur-3xl dark:bg-emerald-500/10" />
            ...
            <div>
              ...
              {forgotSent ? (
                <div className="mt-6 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-5 text-center">
                  <Mail className="mx-auto mb-2 size-8 text-emerald-600 dark:text-emerald-400" />
                  <p className="text-sm font-medium text-foreground">
                    Email đã được gửi!
                  </p>
                  <p className="mt-1 text-xs text-muted-foreground">
                    Kiểm tra hộp thư tại{" "}
                ...
                >
                  ...
                  {forgotPw.isError && (
                    <p className="text-center text-sm text-red-500">
                      {forgotPw.error instanceof AxiosError
                        ? forgotPw.error.response?.data?.message || "Có lỗi xảy ra"
                        : "Có lỗi xảy ra"}
                    </p>
                  )}
                </form>
      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="relative flex h-full flex-col items-end justify-end p-10 text-white">
          ...
          <p className="mt-2 max-w-sm text-right text-sm text-white/80">
            Truy cập hàng trăm AI API cho video, hình ảnh, âm nhạc và chat với
            giá cả hợp lý.
          </p>
        </div>
      </div>
